...
contextBridge.exposeInMainWorld('settings', {
    ...
    get_git_author_name: () =>
        ipcRenderer.invoke('settings:get_git_author_name'),
    set_git_author_name: (name: string) =>
        ipcRenderer.invoke('settings:set_git_author_name', name),
    get_git_author_email: () =>
        ipcRenderer.invoke('settings:get_git_author_email'),
    set_git_author_email: (name: string) =>
        ipcRenderer.invoke('settings:set_git_author_email', name),
