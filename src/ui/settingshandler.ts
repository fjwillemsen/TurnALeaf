...
export class Settings extends AbstractSettings {
    ...
    get git_author_name(): string {
        return window.settings.get_git_author_name()
    }
    set git_author_name(name: string) {
        window.settings.set_git_author_name(name)
    }
    get git_author_email(): string {
        return window.settings.get_git_author_email()
    }
    set git_author_email(email: string) {
        window.settings.set_git_author_email(email)
    }
